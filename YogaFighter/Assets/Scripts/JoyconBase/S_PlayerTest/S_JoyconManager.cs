...
using UnityEngine;
using System;
public class S_JoyconManager : MonoBehaviour
{
    ...
    public List<S_Joycon> j; // Array of all connected Joy-Cons
    static S_JoyconManager instance;

    public static S_JoyconManager Instance
    {
        get { return instance; }
    }
    ...
    void Awake()
    {
        ...
        while (ptr != IntPtr.Zero)
        {
            ...
            if (enumerate.product_id == product_l || enumerate.product_id == product_r)
            {
                ...
                j.Add(new S_Joycon(handle, EnableIMU, EnableLocalize & EnableIMU, 0.05f, isLeft));
                ++i;
            }
            ptr = enumerate.next;
        }
